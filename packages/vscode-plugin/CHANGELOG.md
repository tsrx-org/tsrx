...
- Updated dependencies
  ...
  - @tsrx/typescript-plugin@0.4.13
  - @tsrx/language-server@0.4.13
...
- Updated dependencies []:
  - @tsrx/language-server@0.4.0
  - @tsrx/typescript-plugin@0.4.0
...
- Updated dependencies []:
  - @tsrx/language-server@0.3.137
  - @tsrx/typescript-plugin@0.3.137
...
- Updated dependencies []:
  - @tsrx/language-server@0.3.136
  - @tsrx/typescript-plugin@0.3.136
...
- [#53](https://github.com/tsrx-org/tsrx/pull/53)
  ...
  `<style apply={…} />` blocks, `apply` expressions containing `>`, and `<style>`
  blocks in every template position.
