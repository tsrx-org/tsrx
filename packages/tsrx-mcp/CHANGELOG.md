...
- [#110](https://github.com/tsrx-org/tsrx/pull/110)
  ...
  Thanks [@leonidaz](https://github.com/leonidaz)! - Drop the lazy destructuring
  entry from the generated docs index and the server prompt, per
